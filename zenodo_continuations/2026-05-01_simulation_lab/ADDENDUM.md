...
- `model-lineage-app/`: a static interactive dashboard for model contributions,
  disagreement distance, apparent coherence, validation pressure, and
  hallucination-risk pressure.
- `experiments/MODEL_LINEAGE_REPORT_2026-05-01.md`: a plain-language summary of
  the first model-lineage archive.

## Scientific Status

This update does not claim that the LSC physics line is validated. It documents a
testing layer for the dual interpretation already stated in the main MDLH record:
...
- MDLH / MHLM record: https://doi.org/10.5281/zenodo.19851006
- LSC 6.2.0 related record: https://doi.org/10.5281/zenodo.19878587
- GitHub repository: https://github.com/luciferprosun/LSC_MDLH_PRO
- Public simulator: https://luciferprosun.github.io/akasha-chronicles/model-lineage/
